function Invoke-PSModuleTest {
    ...
    Write-Host "::group::[$moduleName] - Testing - PSScriptAnalyzer"
    $containerParams = @{
    ...
    Write-Host "::group::[$moduleName] - Testing - PSModule"
    ...
    if ($CustomTestsPath) {
        ...
        Write-Host "::group::[$moduleName] - Testing - Module specific tests"
